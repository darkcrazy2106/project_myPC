            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav me-auto">
                        <!-- Logo -->
                        <a class="navbar-brand" href="{{ route('admin.blog.index') }}">BLOG FEEDBACK</a>
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav"> 
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            <a class="has-arrow waves-effect waves-dark active" href="{{ route('admin.feedback.blogfeedback') }}" aria-expanded="false"><span class="hide-menu">Blog Feedbacks</span></a>
