					...
					<div class="col-md-12">
						...
						<div class="single-product-tab custom-tab">
							...
							<ul class="nav nav-tabs" role="tablist">
								<li><a href="{{ route('search-products', ['category'=>'acer']) }}">Acer</a></li> <!-- href="#viewed" -->
							</ul>
							<!-- End Tabs Bar -->
									...
									<div id="bestsell-carousel" class="owl-carousel custom-carousel">
										...
										@foreach ($productList as $acer)
											@if ($acer->category_name == 'acer')
												...
												<form>
													@csrf
													<input type="hidden" value="{{$acer->id}}" class="cart_product_id_{{ $acer->id}}">
													<input type="hidden" value="{{$acer->product_code}}" class="cart_product_code_{{ $acer->id}}">
													<input type="hidden" value="{{$acer->name}}" class="cart_product_name_{{ $acer->id}}">
													<input type="hidden" value="{{$acer->img_path}}" class="cart_product_img_{{ $acer->id}}">
													<input type="hidden" value="{{$acer->price}}" class="cart_product_price_{{ $acer->id}}">
													<input type="hidden" value="{{$acer->quantity}}" class="cart_product_storage_{{ $acer->id}}">
													<input type="hidden" value="1" class="cart_product_quantity_{{ $acer->id}}">
														<div class="singel-product single-product-col">
															<div class="label-pro-sale">hot</div>
															<!-- Single Product Image -->
															<div class="single-product-img">
																<a href="{{ route('products-details', ['id'=>$acer->id]) }}"><img src="images/{{ $acer->img_path}}" alt="{{ $acer->name}}"></a>
															</div>
															<!-- Single Product Content -->
															<div class="single-product-content">
																<h2 class="product-name"><a title="{{ $acer->name}}" href="{{ route('products-details', ['id'=>$acer->id]) }}"> {{ $acer->name}}</a></h2>
																<div class="product-price">
																	<p>${{number_format($acer->price,2)}}</p>
																</div>
																<!-- Single Product Actions -->
																<div class="product-actions">
																	<button class="button btn-cart add-to-cart" data-id="{{ $acer->id}}" name="add-to-cart" title="Add to Cart" type="button"><i class="fa fa-shopping-cart">&nbsp;</i><span>Add to Cart</span></button>
					...
					<div class="col-lg-12">
						...
						<div class="product-view-area fix">
							...
							<div class="single-product-category">
								<!-- Product Category Title-->
								<ul class="nav nav-tabs" role="tablist">
									<li><a href="{{ route('search-products', ['category'=>'keyboard']) }}">Keyboard</a></li> <!-- href="#viewed" -->
								</ul>
								<!-- Product View -->
								<div class="product-view">
									<!-- Product View Carousel -->
										...
										@foreach ($productList as $keyboard)
											@if ($keyboard->category_name == 'keyboard')
												<div class="singel-product single-product-col">
													...
													<!-- Single Product Image -->
													<div class="single-product-img">
														<a href="{{ route('products-details', ['id'=>$keyboard->id]) }}"><img src="images/{{$keyboard->img_path}}" alt="{{$keyboard->name}}"></a>
													</div>
													<!-- Single Product Content -->
													<form>
														@csrf
															<input type="hidden" value="{{$keyboard->id}}" class="cart_product_id_{{ $keyboard->id}}">
															<input type="hidden" value="{{$keyboard->product_code}}" class="cart_product_code_{{ $keyboard->id}}">
															<input type="hidden" value="{{$keyboard->name}}" class="cart_product_name_{{ $keyboard->id}}">
															<input type="hidden" value="{{$keyboard->img_path}}" class="cart_product_img_{{ $keyboard->id}}">
															<input type="hidden" value="{{$keyboard->price}}" class="cart_product_price_{{ $keyboard->id}}">
															<input type="hidden" value="{{$keyboard->quantity}}" class="cart_product_storage_{{ $keyboard->id}}">
															<input type="hidden" value="1" class="cart_product_quantity_{{ $keyboard->id}}">
														<div class="single-product-content">
															<h2 class="product-name"><a title="{{$keyboard->name}}" href="{{ route('products-details', ['id'=>$keyboard->id]) }}"> {{$keyboard->name}}</a></h2>
															<div class="product-price">
																<p>
																	<span>$2099</span>
															...
															<!-- Single Product Actions -->
															<div class="product-actions">
																<button class="button btn-cart add-to-cart" data-id="{{ $keyboard->id}}" name="add-to-cart" title="Add to Cart" type="button"><i class="fa fa-shopping-cart">&nbsp;</i><span>Add to Cart</span></button>
																{{-- <div class="add-to-link">
																	<ul class="">
																		<li class="quic-view"><button type="button" data-bs-target="#productModal" data-bs-toggle="modal"><i class="fa fa-search"></i>Quick view</button></li>
																		<li class="wishlist"><a href="#"><i class="fa fa-heart"></i></a></li>
							...
							<div class="single-product-category">
								<!-- Product Category Title-->
								<ul class="nav nav-tabs" role="tablist">
									<li><a href="{{ route('search-products', ['category'=>'ram']) }}">RAM</a></li> <!-- href="#viewed" -->
								</ul>
								<!-- Product View -->
								<div class="product-view">
									<!-- Product View Carousel -->
										...
										@foreach ($productList as $ram)
											@if ($ram->category_name == 'ram')
												<div class="singel-product single-product-col">
													...
													<!-- Single Product Image -->
													<div class="single-product-img">
														<a href="{{ route('products-details', ['id'=>$ram->id]) }}"><img src="images/{{$ram->img_path}}" alt="{{$ram->name}}"></a>
													</div>
													<!-- Single Product Content -->
													<form>
														@csrf
															<input type="hidden" value="{{$ram->id}}" class="cart_product_id_{{ $ram->id}}">
															<input type="hidden" value="{{$ram->product_code}}" class="cart_product_code_{{ $ram->id}}">
															<input type="hidden" value="{{$ram->name}}" class="cart_product_name_{{ $ram->id}}">
															<input type="hidden" value="{{$ram->img_path}}" class="cart_product_img_{{ $ram->id}}">
															<input type="hidden" value="{{$ram->price}}" class="cart_product_price_{{ $ram->id}}">
															<input type="hidden" value="{{$ram->quantity}}" class="cart_product_storage_{{ $ram->id}}">
															<input type="hidden" value="1" class="cart_product_quantity_{{ $ram->id}}">
														<div class="single-product-content">
															<h2 class="product-name"><a title="{{$ram->name}}" href="{{ route('products-details', ['id'=>$ram->id]) }}"> {{$ram->name}}</a></h2>
															<div class="product-price">
																<p>
																	<span>$2099</span>
															...
															<!-- Single Product Actions -->
															<div class="product-actions">
																<button class="button btn-cart add-to-cart" data-id="{{ $ram->id}}" name="add-to-cart" title="Add to Cart" type="button"><i class="fa fa-shopping-cart">&nbsp;</i><span>Add to Cart</span></button>
																{{-- <div class="add-to-link">
																	<ul class="">
																		<li class="quic-view"><button type="button" data-bs-target="#productModal" data-bs-toggle="modal"><i class="fa fa-search"></i>Quick view</button></li>
																		<li class="wishlist"><a href="#"><i class="fa fa-heart"></i></a></li>
